...
//材质初始化
function materialinit(matInfo, islights=true, isdithering=true, vertexShader, fragmentShader,isNeedUpdate=true) {
     
    let resultMat=new THREE.ShaderMaterial({
        uniforms:
            mergeUniforms([
                UniformsLib.lights,
                matInfo
    ...
    //允许材质更新
    resultMat.uniformsNeedUpdate = isNeedUpdate;
    resultMat.needsUpdate = isNeedUpdate; 
    return resultMat;
}
export { materialInfo,materialinit}